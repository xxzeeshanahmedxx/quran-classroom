...
interface AnimateOpts {
  ...
  ease?: (t: number) => void; onUpdate: (v: number) => void; onEnd?: () => void;
}
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  useEffect(() => {
    ...
    setEdgeProximity(0);
    const t1 = setTimeout(() => setEdgeProximity(0.5), 500);
    const t2 = setTimeout(() => setCursorAngle(angleEnd), 2000);
    const t3 = setTimeout(() => { setSweepActive(false); setEdgeProximity(0); }, 4000);
